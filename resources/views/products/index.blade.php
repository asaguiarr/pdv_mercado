...
<div class="d-flex justify-content-between align-items-center mb-4">
    <h1 class="h2 fw-bold text-gray-800">Gestão de Produtos</h1>
    <button type="button" class="btn btn-warning" data-bs-toggle="modal" data-bs-target="#productModal">
    ...
    <form method="POST" action="{{ route('products.store') }}">
        ...
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title fw-bold" id="productModalTitle">Novo Produto</h5>
